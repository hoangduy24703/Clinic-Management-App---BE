...
BEGIN TRY
		...
		IF NOT EXISTS (SELECT * FROM HOADON with (updlock) WHERE IDBUOIDIEUTRI = @IDBUOIDIEUTRI AND NGAYGIAODICH  IS NULL)
		BEGIN
		...
		SELECT @TONGTIEN = TONGTIEN FROM BUOIDIEUTRI with (updlock)
