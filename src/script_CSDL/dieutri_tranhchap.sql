...
--UNREPEATABLE READ: XEM CHI TIẾT TRƯỚC, XÓA BUỔI ĐIỀU TRỊ -- CHƯA XONG -- NÊN BỎ
...
BEGIN TRAN
	BEGIN TRY
		...
		IF (NOT EXISTS (SELECT IDBUOIDIEUTRI FROM BUOIDIEUTRI WHERE IDBUOIDIEUTRI = @IDBUOIDIEUTRI)) 
			BEGIN
