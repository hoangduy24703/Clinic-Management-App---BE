...
ALTER TABLE LICHHEN
DROP CONSTRAINT CK_VAITRO_LICHHEN;
...
ALTER TABLE LICHHEN
DROP CONSTRAINT CK_TINHTRANG_LICHHEN;

ALTER TABLE LICHHEN
ALTER COLUMN TINHTRANG NCHAR(15);

ALTER TABLE LICHHEN
ADD CONSTRAINT CK_TINHTRANG_LICHHEN
CHECK (TINHTRANG IN (N'CUỘC HẸN MỚI', N'TÁI KHÁM'));
