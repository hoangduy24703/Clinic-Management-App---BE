...
ALTER COLUMN GHICHUKHDT NVARCHAR(100)
...
ALTER COLUMN GHICHUBDT NVARCHAR(100)

ALTER TABLE BUOIDIEUTRI
ALTER COLUMN KEHOACHDT CHAR(10)
...
--ALTER TABLE HOADON
--DROP CONSTRAINT CK_NGAYGD_HOADON
...
ALTER TABLE LICHHEN
ALTER COLUMN TINHTRANG NVARCHAR(15);
...
--CHI TIẾT SỬA SCRIPT SAU KHI PULL VỀ
-- BƯỚC 1:
